/* ================================================================
   CLINIC_DATA — NGUỒN DỮ LIỆU DUY NHẤT CHO CẢ 4 TRANG.
   Sửa nội dung/giá/link ở ĐÂY, tất cả các trang (index, about-us,
   treatments, contact) sẽ tự động cập nhật theo — không cần sửa
   từng file HTML riêng lẻ.

   Chỗ nào ghi [CẬP NHẬT] là nội dung tạm (do website cũ không có
   sẵn dữ liệu thật) — vui lòng điền lại trước khi đăng chính thức.
================================================================= */
const CLINIC_DATA = {
  clinicName: "Thẩm Mỹ Thanh Tuyền",
  tagline: "Vẻ đẹp được lắng nghe, sự tự tin được nâng niu.",

  /* ===== ẢNH DÙNG CHUNG — dán link Unsplash bất kỳ để thay ===== */
  images: {
    heroSlides: [
      "https://images.unsplash.com/photo-1758448500688-3ababa93fd67?auto=format&fit=crop&w=1800&q=80", // sảnh/không gian sang trọng
      "https://images.unsplash.com/photo-1662543701887-91f8f042a338?auto=format&fit=crop&w=1800&q=80", // phòng khám hiện đại
      "https://images.unsplash.com/photo-1569925444984-9e2e5fc3d1fb?auto=format&fit=crop&w=1800&q=80"  // khách hàng rạng rỡ
    ],
  ...
  doctor: {
    ...
    credentials: [
      { title: "Trực tiếp thăm khám & phẫu thuật", desc: "Không giao phó cho trợ lý — bác sĩ đồng hành xuyên suốt hành trình." },
      { title: "Cơ sở được cấp phép hợp pháp", desc: "Giấy phép hoạt động khám chữa bệnh do Sở Y tế cấp, tuân thủ đầy đủ quy chuẩn." },
      { title: "Phác đồ cá nhân hoá", desc: "Mỗi ca đều được đo đạc, thiết kế riêng theo cấu trúc gương mặt." },
      { title: "Trang thiết bị & quy trình vô khuẩn đạt chuẩn", desc: "[CẬP NHẬT] Bổ sung tên thiết bị/công nghệ chính hãng đang sử dụng." }
    ]
  },

  /* ===== VIDEO YOUTUBE — dán videoId thật vào để thay placeholder ===== */
  youtube: {
    channelUrl: "https://www.youtube.com/channel/UCrSc0Hp6PVOk-9icntZzdrg",
    videos: [
      { title: "Hỏi gì đáp nấy cùng Bác Sĩ Tuyền", videoId: "DÁN_ID_VIDEO_1" },
  ...
  treatments: [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1758448500688-3ababa93fd67?auto=format&fit=crop&w=900&q=80"
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1569925444984-9e2e5fc3d1fb?auto=format&fit=crop&w=900&q=60"
    }
  ],
