...
const CLINIC_DATA = {
  ...
  "doctor": {
    ...
    "credentials": [
      {
        "title": "Trực tiếp thăm khám & phẫu thuật",
        "desc": "Không giao phó cho trợ lý — bác sĩ đồng hành xuyên suốt hành trình."
      },
      {
      ...
      },
      {
        ...
        "desc": "Mỗi ca đều được đo đạc, thiết kế riêng theo cấu trúc gương mặt."
      },
      {
        "title": "Trang thiết bị & quy trình vô khuẩn đạt chuẩn",
        "desc": "[CẬP NHẬT] Bổ sung tên thiết bị/công nghệ chính hãng đang sử dụng."
      }
    ]
  },
  "youtube": {
